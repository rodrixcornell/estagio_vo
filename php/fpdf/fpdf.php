...
function Header(){
	global $pathimg;
	$tamFonte = !$this->tamFonte ? 13 : $this->tamFonte;
	//Logotipo
	$this->Image($pathimg.'topo/logo_pref.png',8,4,47,23);
	//Fonte
	...
	$this->SetX((210-$w)/2);
	//$Titulo
	$this->MultiCell($w,5,utf8_decode($this->titulo),0,'C',false);
	$this->Image($pathimg.'topo/dsti.png',157,5,46);
	$this->Ln(12);
	$this->SetLineWidth('0.3');
	$this->Cell(193,3,'','T',0,'L');
}
