    ...
    <div id="conteudo">
        <form name="form" action="{$url}src/{$pasta}/cadastrar.php" method="post">
            ...
            <fieldset>
                ...
                {*--------Cód. Contrato----------*}
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:175px;" >
                    <font color="#FF0000">*</font>Cód. Contrato <font color="#FF0000">{$validar.ID_CONTRATO}</font><br />
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:135px;" >
                    Tipo de Vaga
                ...
                {*----CPF do Estagiário-----*}
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:138px;" >
                    CPF do Estagiário
                    <input type="text" name="NB_CPF" id="NB_CPF" value="{$VO->NB_CPF}"  style="width:132px;" class="leitura" readonly="readonly" />
                </div>
                <br />
                {*-----Instituição de Ensino------*}
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:305px;" >
                    Instituição de Ensino
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:155px;" >
                    Agente de Integração<font color="#FF0000"> {$validar.TX_AGENCIA_ESTAGIO} </font><br />
                ...
                {*------Agente Setorial----------*}
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:330px;" >
                    <font color="#FF0000">*</font>Agente Setorial <font color="#FF0000">{$validar.ID_SETORIAL_ESTAGIO}</font><br />
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:210px;" >
                    <font color="#FF0000">*</font>Cargo / Função <font color="#FF0000"> {$validar.TX_CARGO_AGENTE} </font><br />
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >
                    <font color="#FF0000">*</font>Telefone <font color="#FF0000"> {$validar.TX_FONE_AGENTE} </font><br />
            ...
            <fieldset>
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:500px; text-align:right;" >
                    <font color="#FF0000">{$validar.TX_ALTERACOES}</font>
                </div><br />

                <input name="NB_VIGENCIA" type="checkbox" id="NB_VIGENCIA" value="1" {if $VO->NB_VIGENCIA}checked{/if} />Nova Vigência  <br />
                <div id="camada" style="width:150px;"><font color="#FF0000">*</font>Inicio de Vigência<font color="#FF0000"> {$validar.DT_INICIO_PRORROGACAO} </font><br />
                    <input type="text" name="DT_INICIO_PRORROGACAO" id="DT_INICIO_PRORROGACAO" value="{$VO->DT_INICIO_PRORROGACAO}" {if $VO->NB_VIGENCIA}disabled="false"{/if} style="width:140px; text-align:center;" />
                </div>
                ...
                <input name="NB_JORNADA" type="checkbox" id="NB_JORNADA" value="1" {if $VO->NB_JORNADA}checked{/if} />Alteração de Horário <br />
                ...
                {*--------------Alteracao de  bolsa--------------------------------------*}
                <input name="NB_BOLSA" type="checkbox" id="NB_BOLSA" value="1" {if $VO->NB_BOLSA}checked{/if} /></font>Alteração de Bolsa <br />
                ...
                {*-----------Outras Alterações---------------------*}
                <input name="NB_ALTERACOES" type="checkbox" id="NB_ALTERACOES" value="1" {if $VO->NB_ALTERACOES}checked{/if} /><font color="#FF0000"></font>Outras Alterações <br />
                <div id="camada" style="width:720px;"><font color="#FF0000">*</font>Descrever as Outras Alterações:<font color="#FF0000"> {$validar.TX_OUTRAS_ALTERACOES} </font><br />
                    <textarea maxlength="2000" name="TX_OUTRAS_ALTERACOES" id="TX_OUTRAS_ALTERACOES" style="width:720px;" rows="4">{$VO->TX_OUTRAS_ALTERACOES}</textarea></div>
                <br /><br />
