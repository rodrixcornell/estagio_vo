<div id="centro">
    ...
    <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:120px;" ><strong>Órgão Gestor: </strong></div>
    ...
    <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:120px;" ><strong>Situação: </strong></div>
