        ...
        <form name="form" action="{$url}src/{$pasta}/excluir.php" method="post" >
            <fieldset><!-- Fieldset do Master -->
                ...
                <table width="100%" class="dataGrid">
                    <!-- LINHA (1) -->
                    <tr bgcolor="#E0E0E0">
                        <td style="width:150px;"><strong>Orgão Gestor</strong></td>
                        <td style="width:300px;">{$dados.TX_ORGAO_GESTOR_ESTAGIO[0]}</strong></td>
                        <td style="width:130px;"><strong>Contrato</strong></td>
                        <td>{$dados.NB_CODIGO[0]}</td>
                    </tr>
                    <!-- LINHA (2) -->
                    <tr bgcolor="#F0EFEF">
                        <td><strong>Código da Solicitação</strong></td>
                        <td><font color="#0000FF" class="num_em"><strong>{$dados.TX_CODIGO[0]}</strong></td>
                   ...
                   <tr bgcolor="#E0E0E0">
                    ...
                    <!-- LINHA (5) -->
                     <tr bgcolor="#E0E0E0">
                        <td><strong>Texto da Solicitação</strong></td> 
                        <td colspan="4">{$dados.TX_SOLICITACAO[0]}</td>
                   ...
                   <tr bgcolor="#E0E0E0">
                        ...
                        <td><div id="atualizacao">{$dados.DT_ATUALIZACAO[0]}</div>
                ...
                {/if}
            </fieldset><!-- Fim do Fieldset Master -->
        </form>
        ...
        {if $acesso}
          ...
          <fieldset><!-- 1 fieldset do detail -->
            ...
            <fieldset><!-- 2 fieldset do detail -->
                <legend>Cadastrar Quant. de Vagas</legend>
                <!-- TIPO DE VAGA -->
                <div id="camada" style="width:160px;">
                    ...
                    <select name="CS_TIPO_VAGA_ESTAGIO" id="CS_TIPO_VAGA_ESTAGIO" style="width:150px;">
                        {html_options options=$arrayTipoVaga selected=$VO->TX_TIPO_VAGA_ESTAGIO}
                    </select></div>
                ...
                <div id="camada" style="width:90px;">
                 ...
                 <div id="camada" style="width:120px;">
                    ...
                    <input type="text" name="NB_AUXILIO_TRANSPORTE" id="NB_AUXILIO_TRANSPORTE" value="{$VO->NB_AUXILIO_TRANSPORTE}" style="width:115px;" /></div>&nbsp;
                
                    <!-- BOLSA AUXILIO -->
                 <div id="camada" style="width:120px;">
                    <strong><font color="#FF0000">*</font>Bolsa Auxílio</strong><br />
                    <input type="text" name="NB_BOLSA_AUXILIO" id="NB_BOLSA_AUXILIO" value="{$VO->NB_BOLSA_AUXILIO}" style="width:100px;" /></div>
                   ...
                   <form action="{$url}src/{$pasta}/detail.php" method="post" style="display:inline;">			
                        <input type="submit" name="efetivar" id="efetivar" value=" Efetivar Solicitação " style="margin-top:14px; float:right; padding:4px 8px; font-weight:bold;"/>
                   </form>
