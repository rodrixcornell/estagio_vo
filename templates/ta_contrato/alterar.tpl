...
<div id="centro">
    ...
    <div id="conteudo">
        ...
        <form name="form" action="{$url}src/{$pasta}/alterar.php" method="post">
            ...
            {*-- AGENCIA DE ESTAGIO --   
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >Agência de Estágio 
          ...
          <!-- UNIDADE ORGAO ORIGEM -->   
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:320px;" >
                ...
                <select name="ID_UNIDADE_ORG_DESTINO" id="ID_UNIDADE_ORG_DESTINO" style="width:385px;">
                    {html_options options=$arraybuscarUnidadeOrigem selected=$VO->ID_UNIDADE_ORG_DESTINO}
                </select></div><br/>
                

            <!-- ASSUNTO -->    
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:525px;" >
                <font color="#FF0000">*</font> Assunto <br />
                <input type="text" name="TX_ASSUNTO" id="TX_ASSUNTO" value="{$VO->TX_ASSUNTO}"  style="width:510px;" />
            </div>

            <!-- CODIGO DA SOLICITACAO -->
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:160px;" >
                <font color=""></font> Código da Solicitação <br />
                <input type="text" name="TX_CODIGO" id="TX_CODIGO" value="{$VO->TX_CODIGO}"  style="width:150px;" readonly="readonly" class="leitura"/>
            </div>

            <!-- SITUACAO -->
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >
                <font color="#FF0000">*</font> Situação <font color="#FF0000">{$validar.CS_SITUACAO}</font>
                <select name="CS_SITUACAO" id="CS_SITUACAO" style="width:220px;">
