...
<div id="centro">
    ...
    <br /><br /><br /><hr />
    <div id="conteudo">
        Para alterar o cadastro da {$titulopage} preencha o formulário abaixo e clique em Salvar <br /><br />
        ...
        <form name="form" action="{$url}src/{$pasta}/cadastrar.php" method="post">
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >
            <font color="#FF0000">*</font> Código da Solicitação <br />
            ...
            {html_options options=$$arraySituacao selected=$VO->ID_CONTRATO_CP}
            </select></div><br/>
