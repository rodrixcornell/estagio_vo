    ...
    <div id="conteudo">
        ...
        <form name="form" action="{$url}src/{$pasta}/cadastrar.php" method="post">
            ...
            <legend>Dados do Solicitante</legend>
                ...
                <input type="text" name="TX_ORGAO_ESTAGIO" id="TX_ORGAO_ESTAGIO" value="{$VO->TX_ORGAO_ESTAGIO}" style="width:690px;" class="leitura" readonly="readonly" /></div>
            ...
            <legend>Benefícios ao Estagiário</legend>
                ...
                <font color="#FF0000">*</font>Valor da Bolsa <font color="#FF0000">{$validar.ID_BOLSA_ESTAGIO}</font>
                <select name="ID_BOLSA_ESTAGIO" id="ID_BOLSA_ESTAGIO" style="width:150px;">
