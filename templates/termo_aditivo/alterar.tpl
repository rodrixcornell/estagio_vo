...
<div id="centro">
    ...
    <div id="conteudo">
        Para alterar o Termo Aditivo de Contrato preencha o formulário abaixo e clique em Salvar:<br /><br /><br />
        <form name="form" action="{$url}src/{$pasta}/alterar.php" method="post">
            ...
            <div id="camada" style="width:170px;"> <font color="#FF0000">*</font>Data Início Vigência<font color="#FF0000"> {$validar.DT_INICIO_VIGENCIA} </font><br />
                <input type="text" name="DT_INICIO_VIGENCIA" id="DT_INICIO_VIGENCIA" value="{$VO->DT_INICIO_VIGENCIA}" style="width:160px;" /></div>

            <div id="camada" style="width:170px;"> <font color="#FF0000">*</font>Data Início Vigência<font color="#FF0000"> {$validar.DT_FIM_VIGENCIA} </font><br />
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:310px;">
                Usuário Cadastro <font color="#FF0000">{$validar.TX_FUNCIONARIO_CAD}</font><br />
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;">
                Data Cadastro <font color="#FF0000">{$validar.DT_CADASTRO}</font><br />
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:310px;">
                Usuário Atualização <font color="#FF0000">{$validar.TX_FUNCIONARIO_ATUAL}</font><br />
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;">
                Data Atualização <font color="#FF0000">{$validar.DT_ATUALIZACAO}</font><br />
