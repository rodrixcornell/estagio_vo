       ...
       Para alterar  Recesso do Estagiario preencha o formulário abaixo e clique em Salvar:<br /><br />
        <form name="form" action="{$url}src/{$pasta}/alterar.php" method="post">
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:310px;" >Nome do Estagiário
                <input type="text" name="TX_NOME" id="TX_NOME" value="{$VO->TX_NOME_ESTAGIARIO}"  style="width:300px;" class="leitura" readonly="readonly" />
            </div>  
            <br />
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:155px;">
                ...
                <input type="text" name="DT_FIM_VIGENCIA_ESTAGIO" id="DT_FIM_VIGENCIA_ESTAGIO" value="{$VO->DT_FIM_VIGENCIA_ESTAGIO}" style="width:145px;" class="leitura" readonly="readonly" />
            </div>  
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:120px;">
                <font color="#FF0000">* </font>Fim do Recesso<font color="#FF0000">{$validar.DT_FIM_RECESSO}</font>
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:310px;"><font color="#FF0000">*</font>Chefia Imediata<font color="#FF0000">{$validar.TX_CHEFIA_IMEDIATA}</font>
