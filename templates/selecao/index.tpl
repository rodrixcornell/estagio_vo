<div id="centro">
    ...
    <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:180px;" ><strong>Código da Oferta de Vaga: </strong></div>
    <select name="ID_OFERTA_VAGA" id="ID_OFERTA_VAGA" style="width:200px;">
        ...
        $(document).ready(function() {
            ...
            if ("{$VO->ID_ORGAO_GESTOR_ESTAGIO}" && "{$VO->ID_ORGAO_ESTAGIO}") {
                ...
                $("#tabela").load('acoes.php?identifier=tabela', {
                    ...
                    TX_COD_SELECAO: $.trim("{$VO->TX_COD_SELECAO}"),
                    PAGE: "{$VO->PAGE}"
                }, hideLoader);
            }
