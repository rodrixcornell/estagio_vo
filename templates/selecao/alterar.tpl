    ...
    <div id="conteudo">
        ...
        <form name="form" action="{$url}src/{$pasta}/alterar.php" method="post">
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:160px;" >
                <font color="#FF0000">*</font>Cód. da Oferta de Vaga <font color="#FF0000"> {$validar.TX_CODIGO_OFERTA_VAGA}</font>
                <input type="text" name="TX_CODIGO_OFERTA_VAGA" id="TX_CODIGO_OFERTA_VAGA" style="width:150px;" value="{$VO->TX_CODIGO_OFERTA_VAGA}" class="leitura" readonly="readonly" /></div>

            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:160px;" >
                <font color="#FF0000">*</font>Tipo de Seleção <font color="#FF0000"> {$validar.TX_SELECAO}</font>
                <input type="text" name="TX_SELECAO" id="TX_SELECAO" style="width:150px;" value="{$VO->TX_SELECAO}" class="leitura" readonly="readonly" /></div>
