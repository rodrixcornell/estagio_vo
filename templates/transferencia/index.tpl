<div id="centro">
   ...
   <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >
    ...
    <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:150px;" >
        <strong>Código Tranferência: </strong></div>
    <input type="text" name="ID_TRANSFERENCIA_ESTAGIO" id="ID_TRANSFERENCIA_ESTAGIO" value="{$VO->ID_TRANSFERENCIA_ESTAGIO}"  style="width:200px;" /><br />
<!--ID_ORGAO_GESTOR_ESTAGIO 
    ...
    <script charset="UTF-8" type="text/javascript" language="JavaScript">
        $(document).ready(function(){
            ...
            if ("{$VO->ID_ORGAO_GESTOR_ESTAGIO}" && "{$VO->ID_ORGAO_ESTAGIO}" || ("{$VO->CS_SITUACAO}" || $.trim("{$VO->ID_TRANSFERENCIA_ESTAGIO}"))){
                showLoader();
                //alert('ok: {$VO->ID_ORGAO_GESTOR_ESTAGIO}, {$VO->ID_ORGAO_ESTAGIO}, {$VO->CS_SITUACAO}, {$VO->ID_TRANSFERENCIA_ESTAGIO}.');
