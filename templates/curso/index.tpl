<div id="centro">
    ...
    <br /><br /><br /><hr />
            ...
            <div id="conteudo">
                ...
                <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:180px;"><strong>Curso: </strong></div>
                <input type="text" name="TX_CURSO_ESTAGIO" id="TX_CURSO_ESTAGIO" value="{$VO->TX_CURSO_ESTAGIO}" autocomplete="off" style="width:400px;" />
                <input type="hidden" name="ID_CURSO_ESTAGIO" id="ID_CURSO_ESTAGIO" value="{$VO->ID_CURSO_ESTAGIO}" /><br/>
