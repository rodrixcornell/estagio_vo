...
<!-- linha 1 -->
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:420px;">
                <font color="#FF0000">*</font>Funcionário <font color="#FF0000">{$validar.ID_PESSOA}</font><br />
                <input name="ID_PESSOA" id="ID_PESSOA" value="{$VO->ID_PESSOA}" style="width:410px;" disabled="disabled">
...
<!-- linha 2 -->
            ...
            <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:140px;">
                <font color="#FF0000">*</font>Num.Inscrição <font color="#FF0000">{$validar.TX_MATRICULA}</font><br />
                <input type="text" name="ID_INSCRICAO_CONSELHO" id="ID_INSCRICAO_CONSELHO" value="{$VO->ID_INSCRICAO_CONSELHO}" style="width:130px;" /></div>
<br />
               <div id="camada" style="width:800px;">Curriculo<font color="#FF0000">{$validar.TX_CURRICULO}</font>&nbsp;<br />
