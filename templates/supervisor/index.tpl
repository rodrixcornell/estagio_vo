...
<div id="centro">
    ...
    <div id="conteudo">
             ...
             <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:180px;">
                ...
                <input type="text" name="TX_CARGO" id="TX_CARGO" value="{$VO->TX_CARGO}" style="width:300px;" /><br />
				
             <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:180px;">
                <strong>Nome:</strong><font color="#FF0000">{$validar.NB_FUNCIONARIO}</font></div>
                <select name="NB_FUNCIONARIO" id="NB_FUNCIONARIO" value="{$VO->NB_FUNCIONARIO}" style="width:302px;">
...
$(document).ready(function(){
	...
	if ("{$VO->NB_FUNCIONARIO}" || "{$VO->TX_CARGO}"){
        showLoader();
