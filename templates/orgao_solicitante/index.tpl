            ...
            <div id="conteudo">
                ...
                <br /><br />
                  ...
                  <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:200px;" ><strong>Órgão Solicitante: </strong></div>
                    ...
                    <div id="camada" style="font-family:Verdana, Geneva, sans-serif; width:200px;" ><strong>Unidade Oragazacional: </strong></div>
                    <input type="text" name="TX_UNIDADE_ORGANIZACIONAL" id="TX_UNIDADE_ORGANIZACIONAL" autocomplete="off" style="width:500px;" />
                    <input type="hidden" name="ID_UNIDADE_ORG" id="ID_UNIDADE_ORG" value="0" />
                    <br />
