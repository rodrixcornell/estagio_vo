...
REM INSERTING into SEMAD.GRUPO_PAGAMENTO
SET DEFINE OFF;
Insert into SEMAD.GRUPO_PAGAMENTO (ID_GRUPO_PAGAMENTO,TX_GRUPO_PAGAMENTO) values ('1','Teste1');
Insert into SEMAD.GRUPO_PAGAMENTO (ID_GRUPO_PAGAMENTO,TX_GRUPO_PAGAMENTO) values ('2','Teste2');
Insert into SEMAD.GRUPO_PAGAMENTO (ID_GRUPO_PAGAMENTO,TX_GRUPO_PAGAMENTO) values ('3','Teste3');
--------------------------------------------------------
--  DDL for Index XPKGRUPO_PAGAMENTO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKGRUPO_PAGAMENTO" ON "SEMAD"."GRUPO_PAGAMENTO" ("ID_GRUPO_PAGAMENTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table GRUPO_PAGAMENTO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."GRUPO_PAGAMENTO" MODIFY ("ID_GRUPO_PAGAMENTO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."GRUPO_PAGAMENTO" MODIFY ("TX_GRUPO_PAGAMENTO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."GRUPO_PAGAMENTO" ADD CONSTRAINT "XPKGRUPO_PAGAMENTO" PRIMARY KEY ("ID_GRUPO_PAGAMENTO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_GRUPO_PAGAMENTO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_GRUPO_PAGAMENTO" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Grupo_Pagamento
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('GRUPO_PAGAMENTO');
...
-- insere valor do campo tx_Grupo_Pagamento --
  pnb_Campo := F_AVS_Busca_Campo('TX_GRUPO_PAGAMENTO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Grupo_Pagamento,
          :old.tx_Grupo_Pagamento);


end; --

/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_GRUPO_PAGAMENTO" ENABLE;
--------------------------------------------------------
