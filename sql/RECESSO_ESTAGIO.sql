...
--------------------------------------------------------
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."RECESSO_ESTAGIO"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."RECESSO_ESTAGIO"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
