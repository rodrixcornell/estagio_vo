...
REM INSERTING into SEMAD.CALENDARIO_FOLHA_PAG
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKCALENDARIO_FOLHA_PAG
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKCALENDARIO_FOLHA_PAG" ON "SEMAD"."CALENDARIO_FOLHA_PAG" ("ID_CALENDARIO_FOLHA_PAG") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1CALENDARIO_FOLHA_PAG
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1CALENDARIO_FOLHA_PAG" ON "SEMAD"."CALENDARIO_FOLHA_PAG" ("ID_ORGAO_GESTOR_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table CALENDARIO_FOLHA_PAG
--------------------------------------------------------

  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("ID_CALENDARIO_FOLHA_PAG" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("NB_ANO_REFERENCIA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("NB_MES_REFERENCIA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" MODIFY ("ID_ORGAO_GESTOR_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" ADD CONSTRAINT "XPKCALENDARIO_FOLHA_PAG" PRIMARY KEY ("ID_CALENDARIO_FOLHA_PAG")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CALENDARIO_FOLHA_PAG
--------------------------------------------------------

  ALTER TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" ADD CONSTRAINT "R_3031" FOREIGN KEY ("ID_ORGAO_GESTOR_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_GESTOR_ESTAGIO" ("ID_ORGAO_GESTOR_ESTAGIO") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_CALENDARIO_FOLHA_PAG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_CALENDARIO_FOLHA_PAG" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Calendario_Folha_Pag
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('CALENDARIO_FOLHA_PAG');
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_CALENDARIO_FOLHA_PAG" ENABLE;
--------------------------------------------------------
