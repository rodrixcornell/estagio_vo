...
--------------------------------------------------------
DROP TABLE "SEMAD"."ITEM_TAB_RECESSO" cascade constraints;
DROP TABLE "SEMAD"."TABELA_RECESSO" cascade constraints;
...
--------------------------------------------------------
--  DDL for Table ITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE TABLE "SEMAD"."ITEM_TAB_RECESSO" 
   (	"ID_TABELA_RECESSO" NUMBER(*,0), 
	"NB_ITEM_TAB_RECESSO" NUMBER(*,0), 
	"DT_CADASTRO" DATE, 
	"DT_ATUALIZACAO" DATE, 
	"TX_DURACAO_ESTAGIO" VARCHAR2(255 BYTE), 
	"NB_DURACAO_RECESSO" NUMBER(*,0), 
	"TX_FORMULA_RECESSO" VARCHAR2(255 BYTE), 
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."ITEM_TAB_RECESSO"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."ITEM_TAB_RECESSO"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
--------------------------------------------------------
--  DDL for Table TABELA_RECESSO
--------------------------------------------------------
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."TABELA_RECESSO"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."TABELA_RECESSO"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
REM INSERTING into SEMAD.ITEM_TAB_RECESSO
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKITEM_TAB_RECESSO" ON "SEMAD"."ITEM_TAB_RECESSO" ("ID_TABELA_RECESSO", "NB_ITEM_TAB_RECESSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1ITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1ITEM_TAB_RECESSO" ON "SEMAD"."ITEM_TAB_RECESSO" ("ID_TABELA_RECESSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2ITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2ITEM_TAB_RECESSO" ON "SEMAD"."ITEM_TAB_RECESSO" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF3ITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF3ITEM_TAB_RECESSO" ON "SEMAD"."ITEM_TAB_RECESSO" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table ITEM_TAB_RECESSO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("ID_TABELA_RECESSO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("NB_ITEM_TAB_RECESSO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("TX_DURACAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("NB_DURACAO_RECESSO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" MODIFY ("TX_FORMULA_RECESSO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" ADD CONSTRAINT "XPKITEM_TAB_RECESSO" PRIMARY KEY ("ID_TABELA_RECESSO", "NB_ITEM_TAB_RECESSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ITEM_TAB_RECESSO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" ADD CONSTRAINT "R_2992" FOREIGN KEY ("ID_TABELA_RECESSO")
	  REFERENCES "SEMAD"."TABELA_RECESSO" ("ID_TABELA_RECESSO") ENABLE;
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" ADD CONSTRAINT "R_2995" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
 
  ALTER TABLE "SEMAD"."ITEM_TAB_RECESSO" ADD CONSTRAINT "R_2996" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_ITEM_TAB_RECESSO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_ITEM_TAB_RECESSO" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Item_Tab_Recesso
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('ITEM_TAB_RECESSO');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Tabela_Recesso --
  pnb_Campo := F_AVS_Busca_Campo('ID_TABELA_RECESSO',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Tabela_Recesso,
          :old.ID_Tabela_Recesso);

-- insere valor do campo nb_Item_Tab_Recesso --
  pnb_Campo := F_AVS_Busca_Campo('NB_ITEM_TAB_RECESSO',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.nb_Item_Tab_Recesso,
          :old.nb_Item_Tab_Recesso);
...
-- insere valor do campo tx_Duracao_Estagio --
  pnb_Campo := F_AVS_Busca_Campo('TX_DURACAO_ESTAGIO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Duracao_Estagio,
          :old.tx_Duracao_Estagio);

-- insere valor do campo nb_Duracao_Recesso --
  pnb_Campo := F_AVS_Busca_Campo('NB_DURACAO_RECESSO',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.nb_Duracao_Recesso,
          :old.nb_Duracao_Recesso);

-- insere valor do campo tx_Formula_Recesso --
  pnb_Campo := F_AVS_Busca_Campo('TX_FORMULA_RECESSO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Formula_Recesso,
          :old.tx_Formula_Recesso);
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_ITEM_TAB_RECESSO" ENABLE;
--------------------------------------------------------
