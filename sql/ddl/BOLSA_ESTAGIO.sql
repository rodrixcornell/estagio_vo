--------------------------------------------------------
--  Arquivo criado - Sexta-feira-Abril-25-2014   
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SEMAD.BOLSA_ESTAGIO (NB_BOLSA_ESTAGIO,CS_TIPO_VAGA_ESTAGIO,NB_VALOR,TX_BOLSA_ESTAGIO) values ('3','3','500','Superior 5 Horas');
Insert into SEMAD.BOLSA_ESTAGIO (NB_BOLSA_ESTAGIO,CS_TIPO_VAGA_ESTAGIO,NB_VALOR,TX_BOLSA_ESTAGIO) values ('2','2','400','Superior 4 Horas');
Insert into SEMAD.BOLSA_ESTAGIO (NB_BOLSA_ESTAGIO,CS_TIPO_VAGA_ESTAGIO,NB_VALOR,TX_BOLSA_ESTAGIO) values ('1','1','300','Medio');
Insert into SEMAD.BOLSA_ESTAGIO (NB_BOLSA_ESTAGIO,CS_TIPO_VAGA_ESTAGIO,NB_VALOR,TX_BOLSA_ESTAGIO) values ('4','4','600','Superior 6 Horas');
--------------------------------------------------------
