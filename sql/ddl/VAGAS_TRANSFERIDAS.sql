...
--------------------------------------------------------
DROP TABLE "SEMAD"."VAGAS_TRANSFERIDAS" cascade constraints;
...
--------------------------------------------------------
--  DDL for Table VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE TABLE "SEMAD"."VAGAS_TRANSFERIDAS" 
   (	"ID_TRANSFERENCIA_ESTAGIO" NUMBER(*,0), 
	"ID_QUADRO_VAGAS_ESTAGIO" NUMBER(*,0), 
	"ID_ORGAO_EST_ORIGEM" NUMBER(*,0), 
	"ID_ORGAO_EST_DESTINO" NUMBER(*,0), 
	"NB_QUANTIDADE" NUMBER(*,0), 
	"TX_DOC_AUTORIZACAO" VARCHAR2(255 BYTE), 
	"NB_VAGAS_TRANSFERIDAS" NUMBER(*,0), 
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."VAGAS_TRANSFERIDAS"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."VAGAS_TRANSFERIDAS"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
3 - Cancelada';
   ...
   COMMENT ON COLUMN "SEMAD"."TRANSFERENCIA_VAGAS"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."TRANSFERENCIA_VAGAS"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
REM INSERTING into SEMAD.VAGAS_TRANSFERIDAS
SET DEFINE OFF;
Insert into SEMAD.VAGAS_TRANSFERIDAS (ID_TRANSFERENCIA_ESTAGIO,ID_QUADRO_VAGAS_ESTAGIO,ID_ORGAO_EST_ORIGEM,ID_ORGAO_EST_DESTINO,NB_QUANTIDADE,TX_DOC_AUTORIZACAO,NB_VAGAS_TRANSFERIDAS,CS_TIPO_VAGA_ESTAGIO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,DT_CADASTRO,DT_ATUALIZACAO) values ('126','402','1','223','2',null,'2','2','143','143',to_date('13/01/14','DD/MM/RR'),to_date('13/01/14','DD/MM/RR'));
--------------------------------------------------------
--  DDL for Index XIF4VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF4VAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF5VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF5VAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XPKVAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKVAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_TRANSFERENCIA_ESTAGIO", "NB_VAGAS_TRANSFERIDAS", "ID_QUADRO_VAGAS_ESTAGIO", "ID_ORGAO_EST_ORIGEM", "CS_TIPO_VAGA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1VAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_TRANSFERENCIA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2VAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_QUADRO_VAGAS_ESTAGIO", "ID_ORGAO_EST_ORIGEM", "CS_TIPO_VAGA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF3VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF3VAGAS_TRANSFERIDAS" ON "SEMAD"."VAGAS_TRANSFERIDAS" ("ID_QUADRO_VAGAS_ESTAGIO", "ID_ORGAO_EST_DESTINO", "CS_TIPO_VAGA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table VAGAS_TRANSFERIDAS
--------------------------------------------------------

  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_TRANSFERENCIA_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_QUADRO_VAGAS_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_ORGAO_EST_ORIGEM" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_ORGAO_EST_DESTINO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("NB_QUANTIDADE" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("NB_VAGAS_TRANSFERIDAS" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("CS_TIPO_VAGA_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_USUARIO_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("ID_USUARIO_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" ADD CONSTRAINT "XPKVAGAS_TRANSFERIDAS" PRIMARY KEY ("ID_TRANSFERENCIA_ESTAGIO", "NB_VAGAS_TRANSFERIDAS", "ID_QUADRO_VAGAS_ESTAGIO", "ID_ORGAO_EST_ORIGEM", "CS_TIPO_VAGA_ESTAGIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VAGAS_TRANSFERIDAS
--------------------------------------------------------

  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" ADD CONSTRAINT "R_2903" FOREIGN KEY ("ID_TRANSFERENCIA_ESTAGIO")
	  REFERENCES "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_TRANSFERENCIA_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" ADD CONSTRAINT "R_3027" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."VAGAS_TRANSFERIDAS" ADD CONSTRAINT "R_3028" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_VAGAS_TRANSFERIDAS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_VAGAS_TRANSFERIDAS" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Vagas_Transferidas
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('VAGAS_TRANSFERIDAS');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Transferencia_Estagio --
  pnb_Campo := F_AVS_Busca_Campo('ID_TRANSFERENCIA_ESTAGIO',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Transferencia_Estagio,
          :old.ID_Transferencia_Estagio);

-- insere valor do campo nb_Vagas_Transferidas --
  pnb_Campo := F_AVS_Busca_Campo('NB_VAGAS_TRANSFERIDAS',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.nb_Vagas_Transferidas,
          :old.nb_Vagas_Transferidas);
...
-- insere valor do campo ID_Orgao_Est_Origem --
  pnb_Campo := F_AVS_Busca_Campo('ID_ORGAO_EST_ORIGEM',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Orgao_Est_Origem,
          :old.ID_Orgao_Est_Origem);
...
-- insere valor do campo ID_Orgao_Est_Destino --
  pnb_Campo := F_AVS_Busca_Campo('ID_ORGAO_EST_DESTINO',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Orgao_Est_Destino,
          :old.ID_Orgao_Est_Destino);
...
-- insere valor do campo tx_Doc_Autorizacao --
  pnb_Campo := F_AVS_Busca_Campo('TX_DOC_AUTORIZACAO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_VAGAS_TRANSFERIDAS" ENABLE;
--------------------------------------------------------
