...
REM INSERTING into SEMAD.TABELA_RECESSO
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKTABELA_RECESSO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKTABELA_RECESSO" ON "SEMAD"."TABELA_RECESSO" ("ID_TABELA_RECESSO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1TABELA_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1TABELA_RECESSO" ON "SEMAD"."TABELA_RECESSO" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2TABELA_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2TABELA_RECESSO" ON "SEMAD"."TABELA_RECESSO" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF3TABELA_RECESSO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF3TABELA_RECESSO" ON "SEMAD"."TABELA_RECESSO" ("ID_ORGAO_GESTOR_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table TABELA_RECESSO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."TABELA_RECESSO" MODIFY ("ID_TABELA_RECESSO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" MODIFY ("TX_TABELA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" MODIFY ("ID_ORGAO_GESTOR_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" MODIFY ("DT_INICIO_VIGENCIA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" ADD CONSTRAINT "XPKTABELA_RECESSO" PRIMARY KEY ("ID_TABELA_RECESSO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TABELA_RECESSO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."TABELA_RECESSO" ADD CONSTRAINT "R_2993" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" ADD CONSTRAINT "R_2994" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
 
  ALTER TABLE "SEMAD"."TABELA_RECESSO" ADD CONSTRAINT "R_3006" FOREIGN KEY ("ID_ORGAO_GESTOR_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_GESTOR_ESTAGIO" ("ID_ORGAO_GESTOR_ESTAGIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_TABELA_RECESSO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_TABELA_RECESSO" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Tabela_Recesso
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('TABELA_RECESSO');
...
-- insere valor do campo dt_Atualização --
...
-- insere valor do campo tx_Tabela --
  pnb_Campo := F_AVS_Busca_Campo('TX_TABELA',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_TABELA_RECESSO" ENABLE;
--------------------------------------------------------
