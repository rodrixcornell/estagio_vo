...
--------------------------------------------------------
--  DDL for Table ORGAO_AGENTE_SETORIAL
--------------------------------------------------------
...
REM INSERTING into SEMAD.ORGAO_AGENTE_SETORIAL
SET DEFINE OFF;
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('1','2',to_date('27/09/13','DD/MM/RR'));
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('36','223',to_date('02/10/13','DD/MM/RR'));
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('1','223',to_date('27/09/13','DD/MM/RR'));
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('36','1',to_date('02/10/13','DD/MM/RR'));
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('1','1',to_date('15/10/13','DD/MM/RR'));
Insert into SEMAD.ORGAO_AGENTE_SETORIAL (ID_SETORIAL_ESTAGIO,ID_ORGAO_ESTAGIO,DT_ATUALIZACAO) values ('37','1',to_date('23/01/14','DD/MM/RR'));
--------------------------------------------------------
--  DDL for Index XPKORGAO_AGENTE_SETORIAL
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKORGAO_AGENTE_SETORIAL" ON "SEMAD"."ORGAO_AGENTE_SETORIAL" ("ID_SETORIAL_ESTAGIO", "ID_ORGAO_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1ORGAO_AGENTE_SETORIAL
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1ORGAO_AGENTE_SETORIAL" ON "SEMAD"."ORGAO_AGENTE_SETORIAL" ("ID_SETORIAL_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2ORGAO_AGENTE_SETORIAL
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2ORGAO_AGENTE_SETORIAL" ON "SEMAD"."ORGAO_AGENTE_SETORIAL" ("ID_ORGAO_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table ORGAO_AGENTE_SETORIAL
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" MODIFY ("ID_SETORIAL_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" MODIFY ("ID_ORGAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" ADD PRIMARY KEY ("ID_SETORIAL_ESTAGIO", "ID_ORGAO_ESTAGIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORGAO_AGENTE_SETORIAL
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" ADD FOREIGN KEY ("ID_ORGAO_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."ORGAO_AGENTE_SETORIAL" ADD FOREIGN KEY ("ID_SETORIAL_ESTAGIO")
	  REFERENCES "SEMAD"."AGENTE_SETORIAL_ESTAGIO" ("ID_SETORIAL_ESTAGIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_ORG_AG_SETORIAL
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_ORG_AG_SETORIAL" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on semad.Orgao_Agente_Setorial
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('ORGAO_AGENTE_SETORIAL');
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_ORG_AG_SETORIAL" ENABLE;
--------------------------------------------------------
