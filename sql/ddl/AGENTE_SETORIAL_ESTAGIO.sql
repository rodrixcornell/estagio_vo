...
SET DEFINE OFF;
Insert into SEMAD.AGENTE_SETORIAL_ESTAGIO (ID_SETORIAL_ESTAGIO,ID_USUARIO,DT_CADASTRO,DT_ATULIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,TX_CARGO_FUNCAO,TX_CONTATO,TX_EMAIL) values ('1','143',to_date('26/09/13','DD/MM/RR'),to_date('28/03/14','DD/MM/RR'),'143','143',null,null,'andre.sousa@pmm.am.gov.br');
Insert into SEMAD.AGENTE_SETORIAL_ESTAGIO (ID_SETORIAL_ESTAGIO,ID_USUARIO,DT_CADASTRO,DT_ATULIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,TX_CARGO_FUNCAO,TX_CONTATO,TX_EMAIL) values ('36','3087',to_date('02/10/13','DD/MM/RR'),to_date('02/10/13','DD/MM/RR'),'3087','3087',null,null,'andrecgk@gmail.com');
Insert into SEMAD.AGENTE_SETORIAL_ESTAGIO (ID_SETORIAL_ESTAGIO,ID_USUARIO,DT_CADASTRO,DT_ATULIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,TX_CARGO_FUNCAO,TX_CONTATO,TX_EMAIL) values ('37','3265',to_date('10/10/13','DD/MM/RR'),to_date('23/01/14','DD/MM/RR'),'143','143',null,null,'rodrigo.cabral@pmm.am.gov.br');
--------------------------------------------------------
