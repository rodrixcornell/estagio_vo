...
--------------------------------------------------------
DROP TABLE "SEMAD"."SOLICITACAO_TR" cascade constraints;
...
--------------------------------------------------------
--  DDL for Table SOLICITACAO_TR
--------------------------------------------------------

  CREATE TABLE "SEMAD"."SOLICITACAO_TR" 
   (	"ID_SOLICITACAO_TR" NUMBER(*,0), 
	...
	"DT_TERMINO_ESTAGIO" DATE, 
	"TX_MOTIVO" VARCHAR2(255 BYTE), 
	"TX_OBSERVACAO" VARCHAR2(255 BYTE), 
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_TR"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_TR"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
...
--------------------------------------------------------
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."AGENTE_SETORIAL_ESTAGIO"."ID_USUARIO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
REM INSERTING into SEMAD.SOLICITACAO_TR
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKSOLICITACAO_TR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKSOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_SOLICITACAO_TR") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1SOLICITACAO_TR
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1SOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_CONTRATO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2SOLICITACAO_TR
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2SOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_SETORIAL_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF4SOLICITACAO_TR
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF4SOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_ORGAO_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF5SOLICITACAO_TR
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF5SOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF6SOLICITACAO_TR
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF6SOLICITACAO_TR" ON "SEMAD"."SOLICITACAO_TR" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table SOLICITACAO_TR
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_SOLICITACAO_TR" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("TX_CODIGO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("TX_CARGO_AGENTE" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("TX_EMAIL_AGENTE" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("TX_TELEFONE_AGENTE" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("DT_TERMINO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("TX_MOTIVO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_CONTRATO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_SETORIAL_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_ORGAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("CS_SITUACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_USUARIO_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" MODIFY ("ID_USUARIO_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "XPKSOLICITACAO_TR" PRIMARY KEY ("ID_SOLICITACAO_TR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SOLICITACAO_TR
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "R_2986" FOREIGN KEY ("ID_CONTRATO")
	  REFERENCES "SEMAD"."CONTRATO_ESTAGIO" ("ID_CONTRATO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "R_2987" FOREIGN KEY ("ID_SETORIAL_ESTAGIO")
	  REFERENCES "SEMAD"."AGENTE_SETORIAL_ESTAGIO" ("ID_SETORIAL_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "R_2989" FOREIGN KEY ("ID_ORGAO_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "R_2990" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TR" ADD CONSTRAINT "R_2991" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_SOLICITACAO_TR
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_TR" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Solicitacao_TR
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('SOLICITACAO_TR');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Solicitacao_TR --
  pnb_Campo := F_AVS_Busca_Campo('ID_SOLICITACAO_TR',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Solicitacao_TR,
          :old.ID_Solicitacao_TR);
...
-- insere valor do campo dt_Termino_Estagio --
  pnb_Campo := F_AVS_Busca_Campo('DT_TERMINO_ESTAGIO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Termino_Estagio,
          :old.dt_Termino_Estagio);
...
-- insere valor do campo tx_Observacao --
  pnb_Campo := F_AVS_Busca_Campo('TX_OBSERVACAO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_TR" ENABLE;
--------------------------------------------------------
