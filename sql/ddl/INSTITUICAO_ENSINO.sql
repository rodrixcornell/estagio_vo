...
REM INSERTING into SEMAD.INSTITUICAO_ENSINO
SET DEFINE OFF;
Insert into SEMAD.INSTITUICAO_ENSINO (ID_INSTITUICAO_ENSINO,TX_INSTITUICAO_ENSINO,TX_SIGLA) values ('82','Centro Universitário do Norte','UNINORTE');
Insert into SEMAD.INSTITUICAO_ENSINO (ID_INSTITUICAO_ENSINO,TX_INSTITUICAO_ENSINO,TX_SIGLA) values ('141','Instituto Federal do Amazonas','IFAM');
Insert into SEMAD.INSTITUICAO_ENSINO (ID_INSTITUICAO_ENSINO,TX_INSTITUICAO_ENSINO,TX_SIGLA) values ('29','Universidade Federal do Amazonas','UFAM');
Insert into SEMAD.INSTITUICAO_ENSINO (ID_INSTITUICAO_ENSINO,TX_INSTITUICAO_ENSINO,TX_SIGLA) values ('81','Universidade Nilton Lins','UNINILTONLINS');
Insert into SEMAD.INSTITUICAO_ENSINO (ID_INSTITUICAO_ENSINO,TX_INSTITUICAO_ENSINO,TX_SIGLA) values ('201','Universidade do Estado do Amazonas','UEA');
--------------------------------------------------------
--  DDL for Index XPKINSTITUICAO_ENSINO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKINSTITUICAO_ENSINO" ON "SEMAD"."INSTITUICAO_ENSINO" ("ID_INSTITUICAO_ENSINO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table INSTITUICAO_ENSINO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."INSTITUICAO_ENSINO" MODIFY ("ID_INSTITUICAO_ENSINO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."INSTITUICAO_ENSINO" MODIFY ("TX_INSTITUICAO_ENSINO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."INSTITUICAO_ENSINO" ADD PRIMARY KEY ("ID_INSTITUICAO_ENSINO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_INSTITUICAO_ENSINO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_INSTITUICAO_ENSINO" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on semad.Instituicao_Ensino
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('INSTITUICAO_ENSINO');
...
-- insere valor do campo tx_Instituicao_Ensino --
  pnb_Campo := F_AVS_Busca_Campo('TX_INSTITUICAO_ENSINO',pID_Tabela,'VARCHAR2(255)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Instituicao_Ensino,
          :old.tx_Instituicao_Ensino);
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_INSTITUICAO_ENSINO" ENABLE;
--------------------------------------------------------
