...
--------------------------------------------------------
DROP TABLE "SEMAD"."ITEM_CALENDARIO" cascade constraints;
DROP TABLE "SEMAD"."CALENDARIO_FOLHA_PAG" cascade constraints;
DROP TABLE "SEMAD"."GRUPO_PAGAMENTO" cascade constraints;
...
--------------------------------------------------------
--  DDL for Table ITEM_CALENDARIO
--------------------------------------------------------

  CREATE TABLE "SEMAD"."ITEM_CALENDARIO" 
   (	"ID_CALENDARIO_FOLHA_PAG" NUMBER(*,0), 
	"ID_GRUPO_PAGAMENTO" NUMBER(*,0), 
	"DT_FECHAMENTO" DATE, 
	"DT_ENCAM_DOC" DATE, 
	"DT_TRANSF_BANCO" DATE, 
	"DT_PAGAMENTO" DATE, 
	"DT_INICIO_TRANSF_ESTAG" DATE, 
	"DT_FIM_TRANSF_ESTAG" DATE
  ...
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Table CALENDARIO_FOLHA_PAG
--------------------------------------------------------
  ...
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Table GRUPO_PAGAMENTO
--------------------------------------------------------

  CREATE TABLE "SEMAD"."GRUPO_PAGAMENTO" 
   (	"ID_GRUPO_PAGAMENTO" NUMBER(*,0), 
	"TX_GRUPO_PAGAMENTO" VARCHAR2(255 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
REM INSERTING into SEMAD.ITEM_CALENDARIO
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKITEM_CALENDARIO
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKITEM_CALENDARIO" ON "SEMAD"."ITEM_CALENDARIO" ("ID_CALENDARIO_FOLHA_PAG", "ID_GRUPO_PAGAMENTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1ITEM_CALENDARIO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1ITEM_CALENDARIO" ON "SEMAD"."ITEM_CALENDARIO" ("ID_CALENDARIO_FOLHA_PAG") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2ITEM_CALENDARIO
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2ITEM_CALENDARIO" ON "SEMAD"."ITEM_CALENDARIO" ("ID_GRUPO_PAGAMENTO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table ITEM_CALENDARIO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ITEM_CALENDARIO" MODIFY ("ID_CALENDARIO_FOLHA_PAG" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_CALENDARIO" MODIFY ("ID_GRUPO_PAGAMENTO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."ITEM_CALENDARIO" ADD CONSTRAINT "XPKITEM_CALENDARIO" PRIMARY KEY ("ID_CALENDARIO_FOLHA_PAG", "ID_GRUPO_PAGAMENTO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ITEM_CALENDARIO
--------------------------------------------------------

  ALTER TABLE "SEMAD"."ITEM_CALENDARIO" ADD CONSTRAINT "R_3029" FOREIGN KEY ("ID_CALENDARIO_FOLHA_PAG")
	  REFERENCES "SEMAD"."CALENDARIO_FOLHA_PAG" ("ID_CALENDARIO_FOLHA_PAG") ENABLE;
 
  ALTER TABLE "SEMAD"."ITEM_CALENDARIO" ADD CONSTRAINT "R_3030" FOREIGN KEY ("ID_GRUPO_PAGAMENTO")
	  REFERENCES "SEMAD"."GRUPO_PAGAMENTO" ("ID_GRUPO_PAGAMENTO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_ITEM_CALENDARIO
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_ITEM_CALENDARIO" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Item_Calendario
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('ITEM_CALENDARIO');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Calendario_Folha_Pag --
  pnb_Campo := F_AVS_Busca_Campo('ID_CALENDARIO_FOLHA_PAG',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Calendario_Folha_Pag,
          :old.ID_Calendario_Folha_Pag);

-- insere valor do campo ID_Grupo_Pagamento --
  pnb_Campo := F_AVS_Busca_Campo('ID_GRUPO_PAGAMENTO',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Grupo_Pagamento,
          :old.ID_Grupo_Pagamento);

-- insere valor do campo dt_Fechamento --
  pnb_Campo := F_AVS_Busca_Campo('DT_FECHAMENTO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Encam_Doc --
  pnb_Campo := F_AVS_Busca_Campo('DT_ENCAM_DOC',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Transf_Banco --
  pnb_Campo := F_AVS_Busca_Campo('DT_TRANSF_BANCO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Inicio_Transf_Estag --
  pnb_Campo := F_AVS_Busca_Campo('DT_INICIO_TRANSF_ESTAG',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Inicio_Transf_Estag,
          :old.dt_Inicio_Transf_Estag);

-- insere valor do campo dt_Pagamento --
  pnb_Campo := F_AVS_Busca_Campo('DT_PAGAMENTO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Fim_Transf_Estag --
  pnb_Campo := F_AVS_Busca_Campo('DT_FIM_TRANSF_ESTAG',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Fim_Transf_Estag,
          :old.dt_Fim_Transf_Estag);


end; --

/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_ITEM_CALENDARIO" ENABLE;
--------------------------------------------------------
