...
--------------------------------------------------------
DROP TABLE "SEMAD"."SOLICITACAO_DESLIG" cascade constraints;
...
--------------------------------------------------------
--  DDL for Table SOLICITACAO_DESLIG
--------------------------------------------------------

  CREATE TABLE "SEMAD"."SOLICITACAO_DESLIG" 
   (	"ID_SOLICITACAO_DESLIG" NUMBER(*,0), 
	"DT_CADASTRO" DATE, 
	"DT_ATUALIZACAO" DATE, 
	"DT_SOLICITACAO" DATE, 
	"TX_CODIGO" VARCHAR2(20 BYTE), 
	"TX_OFICIO" VARCHAR2(20 BYTE), 
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_DESLIG"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_DESLIG"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
REM INSERTING into SEMAD.SOLICITACAO_DESLIG
SET DEFINE OFF;
--------------------------------------------------------
--  Constraints for Table SOLICITACAO_DESLIG
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_SOLICITACAO_DESLIG" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("DT_SOLICITACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("TX_CODIGO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("DT_DESLIGAMENTO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_CONTRATO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_USUARIO_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_USUARIO_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("CS_SITUACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_ORGAO_GESTOR_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_ORGAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" MODIFY ("ID_SETORIAL_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "XPKSOLICITACAO_DESLIG" PRIMARY KEY ("ID_SOLICITACAO_DESLIG")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SOLICITACAO_DESLIG
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3032" FOREIGN KEY ("ID_CONTRATO")
	  REFERENCES "SEMAD"."CONTRATO_ESTAGIO" ("ID_CONTRATO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3035" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3036" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3037" FOREIGN KEY ("ID_ORGAO_GESTOR_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_GESTOR_ESTAGIO" ("ID_ORGAO_GESTOR_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3039" FOREIGN KEY ("ID_ORGAO_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_DESLIG" ADD CONSTRAINT "R_3040" FOREIGN KEY ("ID_SETORIAL_ESTAGIO")
	  REFERENCES "SEMAD"."AGENTE_SETORIAL_ESTAGIO" ("ID_SETORIAL_ESTAGIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_SOLICITACAO_DESLIG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_DESLIG" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Solicitacao_Deslig
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('SOLICITACAO_DESLIG');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Solicitacao_Deslig --
  pnb_Campo := F_AVS_Busca_Campo('ID_SOLICITACAO_DESLIG',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Solicitacao_Deslig,
          :old.ID_Solicitacao_Deslig);
...
-- insere valor do campo dt_Solicitacao --
  pnb_Campo := F_AVS_Busca_Campo('DT_SOLICITACAO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo tx_Oficio --
  pnb_Campo := F_AVS_Busca_Campo('TX_OFICIO',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_DESLIG" ENABLE;
--------------------------------------------------------
