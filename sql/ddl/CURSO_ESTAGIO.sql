...
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('121','Sistema de Informação','1');
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('182','Tecnologia em Análise e Desenvolvimento de Sistemas','1');
...
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('61','Ciencia da Computação','1');
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('221','Gestão em Tecnologia da Informação','1');
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('101','Engenharia da Computação','1');
Insert into SEMAD.CURSO_ESTAGIO (ID_CURSO_ESTAGIO,TX_CURSO_ESTAGIO,CS_AREA_CONHECIMENTO) values ('102','Análise de sistema','1');
