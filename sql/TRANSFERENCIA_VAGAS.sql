...
REM INSERTING into SEMAD.TRANSFERENCIA_VAGAS
SET DEFINE OFF;
Insert into SEMAD.TRANSFERENCIA_VAGAS (ID_TRANSFERENCIA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,CS_SITUACAO,ID_USUARIO_ATUALIZACAO,ID_USUARIO_CADASTRO,TX_COD_TRANSFERENCIA,ID_ORGAO_ESTAGIO,ID_ORGAO_GESTOR_ESTAGIO,TX_MOTIVO,ID_ORGAO_SOLICITANTE,ID_QUADRO_VAGAS_ESTAGIO) values ('126',to_date('07/10/13','DD/MM/RR'),to_date('13/01/14','DD/MM/RR'),'1','143','143','00001/2013','1','2','vgft','223','402');
Insert into SEMAD.TRANSFERENCIA_VAGAS (ID_TRANSFERENCIA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,CS_SITUACAO,ID_USUARIO_ATUALIZACAO,ID_USUARIO_CADASTRO,TX_COD_TRANSFERENCIA,ID_ORGAO_ESTAGIO,ID_ORGAO_GESTOR_ESTAGIO,TX_MOTIVO,ID_ORGAO_SOLICITANTE,ID_QUADRO_VAGAS_ESTAGIO) values ('129',to_date('17/01/14','DD/MM/RR'),to_date('17/01/14','DD/MM/RR'),'1','143','143','00001/2014','1','2','fdgfdgdgdg','223','441');
--------------------------------------------------------
--  DDL for Index XIF6TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF6TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_QUADRO_VAGAS_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF5TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF5TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_ORGAO_SOLICITANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XPKTRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKTRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_TRANSFERENCIA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF1TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF1TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF2TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF2TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF3TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF3TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_ORGAO_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF4TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF4TRANSFERENCIA_VAGAS" ON "SEMAD"."TRANSFERENCIA_VAGAS" ("ID_ORGAO_GESTOR_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table TRANSFERENCIA_VAGAS
--------------------------------------------------------

  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("ID_TRANSFERENCIA_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("CS_SITUACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("ID_USUARIO_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("ID_USUARIO_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("TX_COD_TRANSFERENCIA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("ID_ORGAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("ID_ORGAO_GESTOR_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" MODIFY ("TX_MOTIVO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD PRIMARY KEY ("ID_TRANSFERENCIA_ESTAGIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TRANSFERENCIA_VAGAS
--------------------------------------------------------

  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD CONSTRAINT "R_3021" FOREIGN KEY ("ID_ORGAO_SOLICITANTE")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD CONSTRAINT "R_3023" FOREIGN KEY ("ID_QUADRO_VAGAS_ESTAGIO")
	  REFERENCES "SEMAD"."QUADRO_VAGAS_ESTAGIO" ("ID_QUADRO_VAGAS_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD FOREIGN KEY ("ID_ORGAO_GESTOR_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_GESTOR_ESTAGIO" ("ID_ORGAO_GESTOR_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD FOREIGN KEY ("ID_ORGAO_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."TRANSFERENCIA_VAGAS" ADD FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_TRANSFERENCIA_VAGAS" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on SEMAD.Transferencia_Vagas
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('TRANSFERENCIA_VAGAS');
...
-- insere valor do campo tx_Cod_Transferencia --
  pnb_Campo := F_AVS_Busca_Campo('TX_COD_TRANSFERENCIA',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Cod_Transferencia,
          :old.tx_Cod_Transferencia);
...
-- insere valor do campo ID_Orgao_Solicitante --
  pnb_Campo := F_AVS_Busca_Campo('ID_ORGAO_SOLICITANTE',pID_Tabela,'INTEGER');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Orgao_Solicitante,
          :old.ID_Orgao_Solicitante);
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_TRANSFERENCIA_VAGAS" ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_U_TRANSFERENCIA_VAGAS
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_U_TRANSFERENCIA_VAGAS" 
AFTER UPDATE ON SEMAD.TRANSFERENCIA_VAGAS
  REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
...
DECLARE
 ...
 CURSOR C1 IS
     SELECT ID_QUADRO_VAGAS_ESTAGIO,CS_TIPO_VAGA_ESTAGIO,ID_ORGAO_EST_ORIGEM,ID_ORGAO_EST_DESTINO,NB_QUANTIDADE 
     FROM SEMAD.VAGAS_TRANSFERIDAS
     WHERE ID_TRANSFERENCIA_ESTAGIO = :OLD.ID_TRANSFERENCIA_ESTAGIO;
...
BEGIN
     ...
     IF(:NEW.CS_SITUACAO = 2) THEN
       ...
       FOR VAGA IN C1
       LOOP
          UPDATE SEMAD.VAGAS_ESTAGIO
          SET VAGAS_ESTAGIO.NB_QUANTIDADE = (NB_QUANTIDADE - VAGA.NB_QUANTIDADE)
          WHERE VAGAS_ESTAGIO.ID_QUADRO_VAGAS_ESTAGIO = VAGA.ID_QUADRO_VAGAS_ESTAGIO
            AND VAGAS_ESTAGIO.CS_TIPO_VAGA_ESTAGIO = VAGA.CS_TIPO_VAGA_ESTAGIO
            AND VAGAS_ESTAGIO.ID_ORGAO_ESTAGIO = VAGA.ID_ORGAO_EST_ORIGEM;

          UPDATE SEMAD.VAGAS_ESTAGIO
          SET VAGAS_ESTAGIO.NB_QUANTIDADE = (NB_QUANTIDADE + VAGA.NB_QUANTIDADE)
          WHERE VAGAS_ESTAGIO.ID_QUADRO_VAGAS_ESTAGIO = VAGA.ID_QUADRO_VAGAS_ESTAGIO
            AND VAGAS_ESTAGIO.CS_TIPO_VAGA_ESTAGIO = VAGA.CS_TIPO_VAGA_ESTAGIO
            AND VAGAS_ESTAGIO.ID_ORGAO_ESTAGIO = VAGA.ID_ORGAO_EST_DESTINO;
       END LOOP;
...
/
ALTER TRIGGER "SEMAD"."T_U_TRANSFERENCIA_VAGAS" ENABLE;
--------------------------------------------------------
