...
--------------------------------------------------------
--  DDL for Table SOLICITACAO_TA
--------------------------------------------------------

  CREATE TABLE "SEMAD"."SOLICITACAO_TA" 
   (	"ID_SOLICITACAO_TA" NUMBER(*,0), 
	"TX_CODIGO" VARCHAR2(20 BYTE), 
	"DT_CADASTRO" DATE, 
	"DT_ATUALIZACAO" DATE, 
	"TX_FONE_AGENTE" VARCHAR2(20 BYTE), 
	...
	"TX_OUTRAS_ALTERACOES" VARCHAR2(2000 BYTE)
  ...
  TABLESPACE "PMM_DATA" ;
   ...
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_TA"."ID_USUARIO_ATUALIZACAO" IS 'Código do usuário do BD.';
 
   COMMENT ON COLUMN "SEMAD"."SOLICITACAO_TA"."ID_USUARIO_CADASTRO" IS 'Código do usuário do BD.';
--------------------------------------------------------
...
REM INSERTING into SEMAD.SOLICITACAO_TA
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index XPKSOLICITACAO_TA
--------------------------------------------------------

  CREATE UNIQUE INDEX "SEMAD"."XPKSOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_SOLICITACAO_TA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF14SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF14SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_USUARIO_ATUALIZACAO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF15SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF15SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_CONTRATO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF16SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF16SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_USUARIO_CADASTRO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF17SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF17SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_AGENCIA_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF18SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF18SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_ORGAO_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF19SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF19SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_ORGAO_GESTOR_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  DDL for Index XIF20SOLICITACAO_TA
--------------------------------------------------------

  CREATE INDEX "SEMAD"."XIF20SOLICITACAO_TA" ON "SEMAD"."SOLICITACAO_TA" ("ID_SETORIAL_ESTAGIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA" ;
--------------------------------------------------------
--  Constraints for Table SOLICITACAO_TA
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_SOLICITACAO_TA" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("TX_CODIGO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("DT_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("DT_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_USUARIO_ATUALIZACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_CONTRATO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_USUARIO_CADASTRO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_AGENCIA_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_ORGAO_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_ORGAO_GESTOR_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("ID_SETORIAL_ESTAGIO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" MODIFY ("CS_SITUACAO" NOT NULL ENABLE);
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "XPKSOLICITACAO_TA" PRIMARY KEY ("ID_SOLICITACAO_TA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "PMM_DATA"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SOLICITACAO_TA
--------------------------------------------------------

  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2979" FOREIGN KEY ("ID_USUARIO_ATUALIZACAO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2980" FOREIGN KEY ("ID_CONTRATO")
	  REFERENCES "SEMAD"."CONTRATO_ESTAGIO" ("ID_CONTRATO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2981" FOREIGN KEY ("ID_USUARIO_CADASTRO")
	  REFERENCES "SEMAD"."USUARIO" ("ID_USUARIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2982" FOREIGN KEY ("ID_AGENCIA_ESTAGIO")
	  REFERENCES "SEMAD"."AGENCIA_ESTAGIO" ("ID_AGENCIA_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2983" FOREIGN KEY ("ID_ORGAO_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_ESTAGIO" ("ID_ORGAO_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2984" FOREIGN KEY ("ID_ORGAO_GESTOR_ESTAGIO")
	  REFERENCES "SEMAD"."ORGAO_GESTOR_ESTAGIO" ("ID_ORGAO_GESTOR_ESTAGIO") ENABLE;
 
  ALTER TABLE "SEMAD"."SOLICITACAO_TA" ADD CONSTRAINT "R_2985" FOREIGN KEY ("ID_SETORIAL_ESTAGIO")
	  REFERENCES "SEMAD"."AGENTE_SETORIAL_ESTAGIO" ("ID_SETORIAL_ESTAGIO") ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_AVS_IUD_SOLICITACAO_TA
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_TA" 
  AFTER
  INSERT OR DELETE OR UPDATE
  on semad.Solicitacao_TA
...
begin
  ...
  pID_Tabela := F_AVS_Busca_Tabela('SOLICITACAO_TA');
  pnb_Transacao := F_AVS_Cadastra_Transacao(pID_Tabela,pID_usuario,pcs_evento );
  -- insere valor do campo ID_Solicitacao_TA --
  pnb_Campo := F_AVS_Busca_Campo('ID_SOLICITACAO_TA',pID_Tabela,'INTEGER');
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.ID_Solicitacao_TA,
          :old.ID_Solicitacao_TA);
...
-- insere valor do campo tx_Fone_Agente --
  pnb_Campo := F_AVS_Busca_Campo('TX_FONE_AGENTE',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Inicio_prorrogacao --
  pnb_Campo := F_AVS_Busca_Campo('DT_INICIO_PRORROGACAO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Inicio_prorrogacao,
          :old.dt_Inicio_prorrogacao);

-- insere valor do campo dt_Fim_Prorrogacao --
  pnb_Campo := F_AVS_Busca_Campo('DT_FIM_PRORROGACAO',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Fim_Prorrogacao,
          :old.dt_Fim_Prorrogacao);
...
-- insere valor do campo dt_Inicio_Jornada --
  pnb_Campo := F_AVS_Busca_Campo('DT_INICIO_JORNADA',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Inicio_Jornada,
          :old.dt_Inicio_Jornada);

-- insere valor do campo tx_Horas_Jornada --
  pnb_Campo := F_AVS_Busca_Campo('TX_HORAS_JORNADA',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Horas_Jornada,
          :old.tx_Horas_Jornada);

-- insere valor do campo tx_Inicio_Horario --
  pnb_Campo := F_AVS_Busca_Campo('TX_INICIO_HORARIO',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.tx_Inicio_Horario,
          :old.tx_Inicio_Horario);

-- insere valor do campo tx_Fim_Horario --
  pnb_Campo := F_AVS_Busca_Campo('TX_FIM_HORARIO',pID_Tabela,'VARCHAR2(20)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo nb_Valor_Bolsa --
  pnb_Campo := F_AVS_Busca_Campo('NB_VALOR_BOLSA',pID_Tabela,'NUMBER(12,2)');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
...
-- insere valor do campo dt_Inicio_Pag_Bolsa --
  pnb_Campo := F_AVS_Busca_Campo('DT_INICIO_PAG_BOLSA',pID_Tabela,'DATE');
  pnb_Valor_Historico := F_G_PK_Valor_Historico(pID_Tabela,pnb_Transacao,pnb_Campo,pID_usuario);
  insert into semad.Valor_Historico
         (nb_Valor_Historico,
          ID_Tabela,
  ...
  Values (pnb_Valor_Historico,
          ...
          pnb_Campo,
          pID_Usuario,
          :new.dt_Inicio_Pag_Bolsa,
          :old.dt_Inicio_Pag_Bolsa);
...
/
ALTER TRIGGER "SEMAD"."T_AVS_IUD_SOLICITACAO_TA" ENABLE;
--------------------------------------------------------
