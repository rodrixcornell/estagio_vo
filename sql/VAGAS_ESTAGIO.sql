...
SET DEFINE OFF;
Insert into SEMAD.VAGAS_ESTAGIO (ID_QUADRO_VAGAS_ESTAGIO,ID_ORGAO_ESTAGIO,NB_QUANTIDADE,CS_TIPO_VAGA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,ID_CURSO_ESTAGIO,ID_AGENCIA_ESTAGIO) values ('402','223','5','2',to_date('30/09/13','DD/MM/RR'),to_date('30/09/13','DD/MM/RR'),'143','143','61','62');
Insert into SEMAD.VAGAS_ESTAGIO (ID_QUADRO_VAGAS_ESTAGIO,ID_ORGAO_ESTAGIO,NB_QUANTIDADE,CS_TIPO_VAGA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,ID_CURSO_ESTAGIO,ID_AGENCIA_ESTAGIO) values ('402','1','2','2',to_date('01/10/13','DD/MM/RR'),to_date('01/10/13','DD/MM/RR'),'143','143',null,'2');
...
Insert into SEMAD.VAGAS_ESTAGIO (ID_QUADRO_VAGAS_ESTAGIO,ID_ORGAO_ESTAGIO,NB_QUANTIDADE,CS_TIPO_VAGA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,ID_CURSO_ESTAGIO,ID_AGENCIA_ESTAGIO) values ('402','1','1','4',to_date('30/09/13','DD/MM/RR'),to_date('30/09/13','DD/MM/RR'),'143','143','102','62');
Insert into SEMAD.VAGAS_ESTAGIO (ID_QUADRO_VAGAS_ESTAGIO,ID_ORGAO_ESTAGIO,NB_QUANTIDADE,CS_TIPO_VAGA_ESTAGIO,DT_CADASTRO,DT_ATUALIZACAO,ID_USUARIO_CADASTRO,ID_USUARIO_ATUALIZACAO,ID_CURSO_ESTAGIO,ID_AGENCIA_ESTAGIO) values ('402','223','5','1',to_date('30/09/13','DD/MM/RR'),to_date('07/10/13','DD/MM/RR'),'143','143','102','62');
--------------------------------------------------------
