...
class RepositorioSolicitacao extends Repositorio {
    ...
    function buscar($VO) {
        $query = "SELECT a.ID_OFERTA_VAGA,
            a.TX_CODIGO_OFERTA_VAGA,
            B.TX_AGENCIA_ESTAGIO,
            C.TX_ORGAO_GESTOR_ESTAGIO,
            D.TX_TIPO_VAGA_ESTAGIO,
            E.TX_ORGAO_ESTAGIO,
            F.TX_SIGLA_UNIDADE
            ||' - '
            ||F.TX_UNIDADE_ORG TX_ORGAO,
            E.TX_CNPJ,
            a.TX_PESSOA_CONTATO,
            a.TX_TELEFONE,
            a.TX_CARGO_FUNCAO,
            a.TX_EMAIL,
            a.TX_ENDERECO,
            a.TX_PONTO_REFERENCIA,
            a.TX_NUM_ONIBUS,
            a.NB_QUANTIDADE,
            a.NB_QTDE_EMCAMINHADO,
            TO_CHAR(a.DT_ENTREVISTA, 'dd/mm/yyyy') DT_ENTREVISTA,
            a.TX_HORARIO,
            a.NB_DURACAO_ESTAGIO,
            G.NB_VALOR,
            a.NB_VALOR_TRANSPORTE,
            DECODE(a.CS_ESCOLARIDADE, 1, 'Médio', 2, 'Técnico', 3, 'Superior', 4, 'Educação Especial') TX_ESCOLARIDADE,
            H.TX_CURSO_ESTAGIO,
            a.TX_HORA_INICIO,
            a.TX_HORA_FINAL,
            a.TX_OUTROS_HORARIOS,
            a.CS_WINDOWS,
            a.CS_WORD,
            a.CS_EXCEL,
            a.CS_POWERPOINT,
            ...
            a.CS_ALEMAO,
            a.TX_OUTRAS_LINGUAS,
            a.TX_OUTROS_REQUISITOS,
            DECODE(a.CS_SEXO, 1, 'Masculino', 2, 'Feminino') TX_SEXO,
            a.TX_ATIVIDADES,
            a.TX_OBSERVACAO,
            a.ID_QUADRO_VAGAS_ESTAGIO,
            a.ID_AGENCIA_ESTAGIO,
            a.ID_ORGAO_GESTOR_ESTAGIO,
            a.CS_TIPO_VAGA_ESTAGIO,
            a.ID_ORGAO_ESTAGIO,
            a.CS_ESCOLARIDADE,
            a.CS_SEXO,
            a.NB_BOLSA_ESTAGIO,
            ...
            TO_CHAR(a.DT_ATUALIZACAO,'DD/MM/YYYY')DT_ATUALIZACAO_REL,
            ...
            A.CS_SITUACAO,
            DECODE(A.CS_SITUACAO, 1, 'Aberta', 2, 'Efetivada', 3, 'Oferta Encaminhada', 4, 'Cancelada') TX_SITUACAO
          FROM OFERTA_VAGA a,
            AGENCIA_ESTAGIO B,
          ...
          AND a.NB_BOLSA_ESTAGIO                        = G.NB_BOLSA_ESTAGIO
